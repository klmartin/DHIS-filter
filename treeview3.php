					...
					<form method="post" action="treefunctions.php" id="filter">
						<div class="row">
							...
							<div class="col">
								...
								<select name="district" class="form-control " id="district" multiple data-live-search="true">
									<!-- append here -->
								</select>
							</div>
							...
							<div class="col">
								...
								<select name="clinic" class="form-control selectpicker" id="clinic" multiple data-live-search="true">
									<!-- append here -->
								</select>
							</div>
						</div>
